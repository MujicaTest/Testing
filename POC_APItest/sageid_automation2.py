...
if __name__ == "__main__":
    #main()
    sageid_automation = SageIDAuthAutomation(
        "2VTkNzE3St3yShVbZ2cnlkhQVBUHxves",
        "https://id-shadow.sage.com/mobile",
        "openid email profile offline_access user:full",
        "SBCDS/global",
        "test.user4@sage.mailinator.com",
        "sageworks",
        True 
    )
    sageid_automation.get_access_token()
